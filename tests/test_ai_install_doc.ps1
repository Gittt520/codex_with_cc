...
Assert-Contains -Text $aiInstallText -Needle 'macOS 支持尚未实现；需要由安装 AI 参考 `docs/codex_with_cc/windows_scripts` 的行为自行迁移到 `docs/codex_with_cc/macos_scripts`。' -Name 'ai-install-doc-documents-macos-placeholder'
